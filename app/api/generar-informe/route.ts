...
3. SIN MAXIMALISMOS: Prohibido usar adjetivos absolutos o grandilocuentes como "idealmente", "meticulosamente", "crucial", "esencial", "vital", "clave", "excelente", "soberbia", "perfectamente", "clara", "genuina", "total", "óptima", "necesaria" o "crítica". Utiliza una redacción atenuada, equilibrada y profesional (ej: "tiende a", "muestra propensión a", "encuentra facilidad en", "es valorable su disposición para", "se siente más cómodo en"). EXCEPCIÓN OBLIGATORIA: esta atenuación aplica a puntajes moderados. Ante un puntaje extremo (0.0 - 1.0 de 5), la regla de PROPORCIONALIDAD DEL LENGUAJE de más abajo tiene prioridad sobre esta regla — no atenúes ni diluyas ese punto mezclándolo de forma genérica con un factor relacionado de puntaje distinto. SUTILEZA NO ES DAR VUELTAS: esta atenuación es una cuestión de TONO (elegir palabras prudentes y no alarmistas), nunca de OCULTAR o RETRASAR el punto central. En cada fortaleza u oportunidad de mejora, nombra la conducta observada de forma directa desde la primera frase — no la reserves para una segunda oración ni la envuelvas en cláusulas previas que la disimulen. No apiles más de un calificador atenuante en la misma frase (evita, por ejemplo, combinar "podría" + "en ocasiones" + "alguna" en una sola oración) y nunca cierres la idea con una cláusula que la contradiga o le reste peso a lo que acabás de señalar (ej: no termines con "sin que esto represente una dificultad clara" inmediatamente después de describir esa dificultad).
...
3. SIN MAXIMALISMOS: Prohibido usar adjetivos absolutos o grandilocuentes como "idealmente", "meticulosamente", "crucial", "esencial", "vital", "clave", "excelente", "perfectamente", "clara", "genuina", "total", "óptima", "necesaria" o "crítica". Utiliza una redacción atenuada (ej: "tiende a", "muestra propensión a", "encuentra facilidad en"). EXCEPCIÓN OBLIGATORIA: esta atenuación aplica a puntajes moderados. Ante un puntaje extremo (0.0 - 1.0 de 5), la regla de PROPORCIONALIDAD DEL LENGUAJE de la guía de interpretación de abajo tiene prioridad sobre esta regla — no atenúes ni diluyas ese punto mezclándolo de forma genérica con un factor relacionado de puntaje distinto. SUTILEZA NO ES DAR VUELTAS: esta atenuación es una cuestión de TONO, nunca de OCULTAR o RETRASAR el punto central. Nombra la conducta observada de forma directa desde la primera frase de cada descripción — no la reserves para una segunda oración ni la envuelvas en cláusulas previas que la disimulen. No apiles más de un calificador atenuante en la misma frase y nunca cierres la idea con una cláusula que la contradiga o le reste peso a lo que acabás de señalar (ej: no termines con "sin que esto represente una dificultad clara" inmediatamente después de describir esa dificultad).
4. ANONIMATO ABSOLUTO: No utilices el nombre del candidato en ninguna parte del análisis. Refiérete a él/ella únicamente como "el perfil", "la persona evaluada", "el postulante" o mediante estructuras impersonales.
