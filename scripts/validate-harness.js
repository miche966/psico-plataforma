...
const PALABRAS_PROHIBIDAS = [
    ...
    'rimbombante', 'extraordinario', 'magnífico', 'sorprendente', 'fabuloso',
    'fantástico', 'espectacular', 'impresionante', 'genial', 'excelentísimo',
    'brillante', 'colosal', 'épico', 'legendario', 'inigualable'
];
