            ...
            <div style={{ padding: '0 1.25rem' }}>
              {getFactoresUnicos(DOMINIOS.PERSONALIDAD).map(([factor, { valor, sesionId }]) => {
                ...
                const narrativas: Record<string, any> = {
                  extraversion: {
                    alto: 'Demuestra una disposición natural para la interacción y el intercambio de ideas, actuando como un puente positivo en la dinámica del equipo. Se siente cómodo en situaciones que requieren comunicación activa y es capaz de dinamizar el ambiente de trabajo aportando energía y una visión clara del impacto interpersonal.',
                    medio: 'Mantiene un equilibrio profesional entre la colaboración grupal y el trabajo enfocado. Es capaz de integrarse con fluidez a las dinámicas de equipo cuando el objetivo lo requiere, comunicándose de forma clara y eficiente sin descuidar sus momentos de análisis individual.',
                    bajo: 'Muestra una preferencia por entornos de trabajo que privilegian el análisis reflexivo y la concentración profunda. Su mayor valor reside en tareas que requieren autonomía y un procesamiento pausado de la información, lejos de climas de alta estimulación social constante.'
                  },
                  amabilidad: {
                    alto: 'Se destaca por su notable disposición para la colaboración y el soporte mutuo, priorizando la armonía dentro de la organización. Es un perfil orientado a construir acuerdos y fortalecer el clima laboral mediante una actitud empática y una escucha que facilita la resolución constructiva de diferencias.',
                    medio: 'Logra un equilibrio saludable entre la firmeza necesaria para cumplir objetivos y la cordialidad requerida para mantener un buen trato con sus pares. Defiende sus criterios técnicos de forma profesional, asegurando que sus interacciones siempre contribuyan a la estabilidad del equipo.',
                    bajo: 'Prioriza el pragmatismo y la obtención de resultados directos sobre las dinámicas de grupo. Su estilo es franco y orientado a la tarea, lo que resulta muy eficiente en entornos de alta exigencia técnica donde la claridad y la rapidez son factores críticos de éxito.'
                  },
                  responsabilidad: {
                    alto: 'Demuestra una capacidad natural para la organización y el seguimiento de procesos complejos, asegurando la calidad de sus entregables de forma autónoma. Su enfoque en el cumplimiento de los estándares y plazos acordados permite que el equipo confíe plenamente en su gestión y constancia operativa.',
                    medio: 'Organiza su flujo de trabajo de manera funcional, cumpliendo consistentemente con sus responsabilidades profesionales. Es capaz de gestionar sus prioridades con autonomía dentro de marcos predefinidos, manteniendo un estándar de calidad estable en sus funciones diarias.',
                    bajo: 'Su desempeño es más fluido en entornos que brinden objetivos claros de corto plazo y una estructura de seguimiento definida. Se beneficia de herramientas que faciliten la planificación diaria, lo que le permite mantener el foco en las metas inmediatas con efectividad.'
                  },
                  neuroticismo: {
                    alto: 'Muestra una madurez y equilibrio notables frente a situaciones de exigencia o incertidumbre. Su capacidad para mantener la perspectiva bajo presión actúa como un factor de estabilidad para el equipo, permitiéndole abordar los desafíos diarios con una visión objetiva y calmada.',
                    medio: 'Gestiona sus reacciones de forma profesional y equilibrada ante las demandas laborales habituales. Mantiene un rendimiento constante y un trato estable con sus colaboradores, mostrando una capacidad de ajuste adecuada a las variaciones normales de la carga de trabajo.',
                    bajo: 'El perfil se siente más productivo y seguro en entornos de trabajo estables y con metas bien definidas. Ante situaciones de mucha presión o cambios repentinos, se recomienda un liderazgo que brinde claridad y apoyo frecuente para ayudarle a procesar los desafíos sin comprometer su bienestar.'
                  },
                  apertura: {
                    alto: 'Se caracteriza por una disposición activa hacia el aprendizaje y la optimización de procesos. Es un perfil que busca aplicar enfoques nuevos para resolver problemas convencionales, aportando una visión fresca que favorece la actualización y competitividad del área.',
                    medio: 'Muestra una receptividad adecuada hacia el cambio y la actualización de sus competencias. Se adapta con solvencia a nuevas metodologías cuando percibe un beneficio para su tarea diaria, manteniendo un equilibrio entre la innovación y los métodos que ya han demostrado ser efectivos.',
                    bajo: 'Posee una marcada preferencia por los procedimientos establecidos y las rutinas predecibles. Su mayor valor reside en funciones que requieran un seguimiento riguroso de normativas y donde la especialización en tareas conocidas sea el factor clave de éxito operativo.'
                  },
                  normas: {
                    ...
                    medio: 'Demuestra un comportamiento profesional alineado con las normas de convivencia y legalidad de la empresa. Respeta las reglas establecidas y valora la claridad en el trato diario, mostrando un criterio equilibrado.',
                    bajo: 'Podría priorizar resultados inmediatos sobre ciertos marcos normativos en situaciones de ambigüedad. Se recomienda una definición muy clara de los lineamientos de cumplimiento y una comunicación directa de los valores organizacionales.'
                  },
                  honestidad: {
                    alto: 'Se destaca por una comunicación transparente y directa. Su estilo facilita la construcción de confianza y el intercambio de información honesta, siendo un perfil orientado a la claridad y la integridad institucional.',
                    ...
                    bajo: 'En ocasiones podría reservar información para evitar tensiones o conflictos inmediatos. Se sugiere fomentar un canal de comunicación abierto y validar la información importante mediante indicadores objetivos.'
                  },
                  promedio_general: {
                    alto: 'El perfil proyecta una coherencia profesional destacada en su conducta. Sus valores personales se manifiestan en un compromiso sólido con la integridad, favoreciendo una alineación confiable con la cultura de la empresa.',
                    medio: 'Posee un nivel de integridad acorde a las expectativas corporativas. Su comportamiento es predecible dentro de los marcos éticos estándar, mostrando un juicio profesional funcional y equilibrado.',
                    bajo: 'Se identifica una tendencia a priorizar criterios personales o soluciones prácticas sobre los protocolos establecidos. Para una integración segura, se recomienda una inducción intensiva en los valores de la empresa y un acompañamiento que alinee su toma de decisiones con el estándar ético requerido.'
                  }
                };
