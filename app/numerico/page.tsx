...
export default function NumericoPage() {
  ...
  if (finalizado) {
    ...
    const colorNivel = porcentaje >= 80 ? '#16a34a' : porcentaje >= 60 ? '#ea580c' : '#dc2626'
    ...
    <div style={s.contenedor}>
      <div style={s.encabezado}>
        <div style={s.encabezadoTop}>
          <span style={s.testNombre}>Razonamiento Numérico</span>
      ...
      <div style={s.categoriaTag}>
        {item.factor === 'series' ? 'Serie numérica' :
      ...
      <div style={s.opciones}>
        {item.opciones.map((opcion: string, index: number) => (
          <button
            ...
            style={{
              ...s.opcionBoton,
              background: seleccionada === opcion ? '#2563eb' : '#fff',
              color: seleccionada === opcion ? '#fff' : '#1e293b',
              borderColor: seleccionada === opcion ? '#2563eb' : '#e2e8f0',
            }}
...
const s = {
  ...
  testNombre: { fontSize: '0.75rem', fontWeight: '500', color: '#7c3aed', textTransform: 'uppercase' as const, letterSpacing: '0.05em' } as React.CSSProperties,
  ...
  barraRelleno: { height: '100%', background: '#7c3aed', borderRadius: '3px', transition: 'width 0.3s ease' } as React.CSSProperties,
  categoriaTag: { display: 'inline-block', fontSize: '0.75rem', padding: '3px 10px', background: '#f3e8ff', color: '#7c3aed', borderRadius: '99px', marginBottom: '1rem', fontWeight: '500' } as React.CSSProperties,
  ...
  baraTiempo: { width: '100%', height: '4px', background: '#e2e8f0', borderRadius: '2px', overflow: 'hidden' } as React.CSSProperties,
