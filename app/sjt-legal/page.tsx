    ...
    <div style={s.contenedor}>
      <div style={s.encabezado}>
        <div style={s.encabezadoTop}>
          <span style={s.testNombre}>SJT Legal y Jurídico</span>
      ...
      <div style={{ background: '#EEEDFE', border: '1px solid #AFA9EC', borderRadius: '10px', padding: '1rem 1.25rem', marginBottom: '1.25rem' }}>
        <div style={{ fontSize: '10px', fontWeight: '600', color: '#26215C', textTransform: 'uppercase' as const, letterSpacing: '0.05em', marginBottom: '6px' }}>Situación</div>
        <p style={{ fontSize: '13px', color: '#1e293b', lineHeight: '1.6', margin: 0 }}>{item.contenido}</p>
      </div>
      <div style={{ fontSize: '13px', fontWeight: '500', color: '#475569', marginBottom: '0.75rem' }}>¿Qué harías en esta situación?</div>
...
const s = {
  ...
  testNombre: { fontSize: '0.75rem', fontWeight: '500', color: '#534AB7', textTransform: 'uppercase' as const, letterSpacing: '0.05em' } as React.CSSProperties,
  ...
  badge: { fontSize: '10px', padding: '2px 8px', borderRadius: '99px', background: '#EEEDFE', color: '#26215C', fontWeight: '500' } as React.CSSProperties,
  barraFondo: { width: '100%', height: '6px', background: '#e2e8f0', borderRadius: '3px', overflow: 'hidden' } as React.CSSProperties,
  barraRelleno: { height: '100%', background: '#534AB7', borderRadius: '3px', transition: 'width 0.3s ease' } as React.CSSProperties,
  pregunta: { fontSize: '1.1rem', fontWeight: '500', color: '#1e293b', lineHeight: '1.7', marginBottom: '1.75rem', fontFamily: 'sans-serif' } as React.CSSProperties,
